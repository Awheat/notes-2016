...
$(document).ready(function () {
    alert("123123");
    new MySocialShare($("div.mysocialshare"));
...
MySocialShare = function (e) {
    ...
    var p = function () {
        ...
        for (var t = 0; t < r.length; t++) {
            ...
            var o = m[i];
            var u;
            if (o["profile_url"] && $(n).attr("data-" + i + "-handle"))u = o["profile_url"].replace(/\[HANDLE\]/gi, $(n).attr("data-" + i + "-handle")); else continue;
    ...
    var d = {
        bubble: {
            holder: '<a class="msb_main" title="My Networks" alt="My Networks">' + '<img src="[IMAGE_URL]" title="My Networks" alt="My Networks"/>' + "</a>" + '<div class="msb_network_holder"></div>',
            network_button: '<a class="msb_network_button [NETWORK]" href="[URL]" data-network="[NETWORK]">[NAME]</a>',
            orientations: {
                arc: function () {
                    ...
                    if (!$(this).hasClass("active")) {
                        ...
                        $(n).find(".msb_network_button").each(function () {
                            ...
                            $(this).css({
                                ...
                                left: p + "px",
                                top: d + "px"
                            }).stop().delay(t * s).animate({left: (r - 30) + "px", top: (i - 30) + "px"}, e);
                            m += v;
                            s++
                        })
                    } else {
                        ...
                        $(n).find(".msb_network_button").each(function () {
                            $(this).stop().delay(t * s).animate({left: 0, top: 0}, e);
                            s--
                        })
                    }
                }, line: function () {
    ...
    var m = {
        twitter: {profile_url: "#", name: "Twitter"},
        instagram: {profile_url: "mycustom-edit.html", name: "Instagram"}
    };
    t.url = i;
    t.me = e;
    t.networks = r;
